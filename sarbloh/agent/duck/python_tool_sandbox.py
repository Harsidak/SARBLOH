...
from sarbloh.agent.duck import segmentation as _segmentation
from sarbloh.agent.duck.grid_utils import ARC_COLOR_CHARS
...
def _kill_process_group(process: subprocess.Popen[str]) -> None:
    ...
    except (OSError, AttributeError):  # sarbloh: os.killpg does not exist on Windows (local runs)
        try:
            process.kill()
        except OSError:
            pass
